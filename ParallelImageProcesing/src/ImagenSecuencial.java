...
public class ImagenSecuencial {
    ...
    public ImagenSecuencial(String csvFilePath, String currentPhoto) {
    ...
    try {
        ...
        File archivoEntrada = new File(Constants.INPUT_PATH + currentPhoto); // Cambia "imagen.png" por la ruta de tu imagen
        System.out.println("Image size: " + archivoEntrada.length() + " bytes");

        csvLoadData += currentPhoto + "," + archivoEntrada.length() + ",";
        ...
        File archivoSalida = new File(Constants.SECUANCIAL_CSV_CONJUNTO + currentPhoto);
